...
.skl-ds-card-body {
  padding: 8px 16px;
}`, "",{"version":3,"sources":["webpack://./src/stories/components/template/skl-ds-card/skl-ds-card.scss"],"names":[],"mappings":"AAAA;EACE,sBAAA;EACA,mBAAA;EACA,gBAAA;AACF;;AAEA;EACE,uBAAA;EACA,4BAAA;EACA,iBAAA;AACF;;AAIE;EACE,qBAAA;EACA,iBAAA;AADJ;;AAKA;EACE,iBAAA;AAFF","sourcesContent":[".skl-ds-card {\n  background-color: #ccc;\n  border-radius: 16px;\n  max-width: 240px;\n}\n\n.skl-ds-card-header {\n  border: 1px solid black;\n  border-radius: 16px 16px 0 0;\n  padding: 6px 16px;\n}\n\n\n.skl-ds-card--important {\n  .skl-ds-card-header {\n    background-color: red;\n    border-color: red;\n  }\n}\n\n.skl-ds-card-body {\n  padding: 8px 16px;\n}\n\n.skl-ds-card-body__title {\n\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=stories-components-template-skl-ds-card-skl-ds-card-stories.cf244b94c85b5edb76a1.hot-update.js.map