...
.skl-ds-icon--xlarge {
  font-size: 64px;
}`, "",{"version":3,"sources":["webpack://./src/stories/components/atoms/skl-ds-icon/skl-ds-icon.scss"],"names":[],"mappings":"AACA;EACE,qBAAA;EACA,sBAAA;AAAF;;AAGA;EACE,4BAAA;AAAF;;AAGA;EACE,4BAAA;AAAF;;AAGA;EACE,4BAAA;AAAF;;AAGA;EACE,eAAA;AAAF","sourcesContent":["\ni {\n  display: inline-block;\n  vertical-align: middle;\n}\n\n.skl-ds-icon--small {\n  font-size: var(--icon-small)\n}\n\n.skl-ds-icon--medium {\n  font-size: var(--icon-small)\n}\n\n.skl-ds-icon--large {\n  font-size: var(--icon-small)\n}\n\n.skl-ds-icon--xlarge {\n  font-size: 64px;\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=src_stories_components_atoms_skl-ds-icon_skl-ds-icon_jsx.59f37a7852ca07957ab5.hot-update.js.map