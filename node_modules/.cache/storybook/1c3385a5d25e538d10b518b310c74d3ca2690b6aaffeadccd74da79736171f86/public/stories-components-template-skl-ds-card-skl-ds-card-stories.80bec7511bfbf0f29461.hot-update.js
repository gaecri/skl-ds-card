...
.skl-ds-card-body__infos {
  ...
  margin-top: 8px;
}`, "",{"version":3,"sources":["webpack://./src/stories/components/template/skl-ds-card/skl-ds-card.scss"],"names":[],"mappings":"AAAA;EACE,sBAAA;EACA,mBAAA;EACA,gBAAA;AACF;AACE;EACE,eAAA;AACJ;;AAGA;EACE,uBAAA;EACA,4BAAA;EACA,iBAAA;AAAF;;AAKE;EACE,qBAAA;EACA,iBAAA;AAFJ;AAMI;EACE,iBAAA;AAJN;;AASA;EACE,iBAAA;AANF;;AASA;EACE,oBAAA;EACA,4BAAA;EACA,gBAAA;EACA,qBAAA;EACA,uBAAA;AANF;;AASA;EACE,aAAA;EACA,6BAAA;EACA,eAAA;AANF","sourcesContent":[".skl-ds-card {\n  background-color: #ccc;\n  border-radius: 16px;\n  max-width: 240px;\n\n  .skl-ds-divider {\n    margin-top: 8px;\n  }\n}\n\n.skl-ds-card-header {\n  border: 1px solid black;\n  border-radius: 16px 16px 0 0;\n  padding: 6px 16px;\n}\n\n\n.skl-ds-card--important {\n  .skl-ds-card-header {\n    background-color: red;\n    border-color: red;\n  }\n\n  .skl-ds-widget {\n    &:last-child {\n      padding: 8px 10px;\n    }\n  }\n}\n\n.skl-ds-card-body {\n  padding: 8px 16px;\n}\n\n.skl-ds-card-body__title {\n  display: -webkit-box;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n  -webkit-line-clamp: 3;\n  text-overflow: ellipsis;\n}\n\n.skl-ds-card-body__infos {\n  display: flex;\n  justify-content: space-around;\n  margin-top: 8px;\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=stories-components-template-skl-ds-card-skl-ds-card-stories.80bec7511bfbf0f29461.hot-update.js.map