...
}`, "",{"version":3,"sources":["webpack://./src/stories/components/template/skl-ds-card/skl-ds-card.scss"],"names":[],"mappings":"AAAA;EACE,sBAAA;EACA,mBAAA;EACA,gBAAA;AACF;AAMA;EACE,uBAAA;EACA,4BAAA;EACA,iBAAA;AAJF;;AASE;EACE,qBAAA;EACA,iBAAA;AANJ;;AAUA;EACE,iBAAA;AAPF;;AAUA;EACE,oBAAA;EACA,4BAAA;EACA,gBAAA;EACA,qBAAA;EACA,uBAAA;AAPF;;AAUA;EACE,aAAA;EACA,8BAAA;AAPF","sourcesContent":[".skl-ds-card {\n  background-color: #ccc;\n  border-radius: 16px;\n  max-width: 240px;\n\n  .skl-ds-widget {\n    \n  }\n}\n\n.skl-ds-card-header {\n  border: 1px solid black;\n  border-radius: 16px 16px 0 0;\n  padding: 6px 16px;\n}\n\n\n.skl-ds-card--important {\n  .skl-ds-card-header {\n    background-color: red;\n    border-color: red;\n  }\n}\n\n.skl-ds-card-body {\n  padding: 8px 16px;\n}\n\n.skl-ds-card-body__title {\n  display: -webkit-box;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n  -webkit-line-clamp: 3;\n  text-overflow: ellipsis;\n}\n\n.skl-ds-card-body__infos {\n  display: flex;\n  justify-content: space-between;\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=stories-components-template-skl-ds-card-skl-ds-card-stories.1ef2667f8e48094de0e6.hot-update.js.map