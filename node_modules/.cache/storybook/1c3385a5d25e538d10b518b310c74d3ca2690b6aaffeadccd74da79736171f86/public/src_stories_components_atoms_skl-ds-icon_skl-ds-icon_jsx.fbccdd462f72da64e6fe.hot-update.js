...
.skl-ds-icon--xlarge {
  font-size: var(--icon-small);
}`, "",{"version":3,"sources":["webpack://./src/stories/components/atoms/skl-ds-icon/skl-ds-icon.scss"],"names":[],"mappings":"AACA;EACE,qBAAA;EACA,sBAAA;AAAF;;AAGA;EACE,4BAAA;AAAF;;AAGA;EACE,4BAAA;AAAF;;AAGA;EACE,4BAAA;AAAF;;AAGA;EACE,4BAAA;AAAF","sourcesContent":["\ni {\n  display: inline-block;\n  vertical-align: middle;\n}\n\n.skl-ds-icon--small {\n  font-size: var(--icon-small)\n}\n\n.skl-ds-icon--medium {\n  font-size: var(--icon-small)\n}\n\n.skl-ds-icon--large {\n  font-size: var(--icon-small)\n}\n\n.skl-ds-icon--xlarge {\n  font-size: var(--icon-small)\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=src_stories_components_atoms_skl-ds-icon_skl-ds-icon_jsx.fbccdd462f72da64e6fe.hot-update.js.map