...
}`, "",{"version":3,"sources":["webpack://./src/stories/components/template/skl-ds-card/skl-ds-card.scss"],"names":[],"mappings":"AAAA;EACE,sBAAA;EACA,mBAAA;AACF;;AAGA;EACE,uBAAA;EACA,4BAAA;AAAF;;AAME;EACE,qBAAA;AAHJ","sourcesContent":[".skl-ds-card {\n  background-color: #ccc;\n  border-radius: 16px;\n\n}\n\n.skl-ds-card-header {\n  border: 1px solid black;\n  border-radius: 16px 16px 0 0;\n\n}\n\n\n.skl-ds-card--important {\n  .skl-ds-card-header {\n    background-color: red;\n  }\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=stories-components-template-skl-ds-card-skl-ds-card-stories.d4efaf70092a295fae03.hot-update.js.map