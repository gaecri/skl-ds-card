...
.skl-ds-card-header__background-alert {
  background-color: #fff;
}`, "",{"version":3,"sources":["webpack://./src/stories/components/template/skl-ds-card/skl-ds-card.scss"],"names":[],"mappings":"AAAA;EACE,sBAAA;EACA,mBAAA;AACF;;AAEA;EACE,sBAAA;AACF","sourcesContent":[".skl-ds-card {\n  background-color: #fff;\n  border-radius: 16px;\n}\n\n.skl-ds-card-header__background-alert {\n  background-color: #fff;\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=stories-components-template-skl-ds-card-skl-ds-card-stories.86d16895bbf78ab90480.hot-update.js.map