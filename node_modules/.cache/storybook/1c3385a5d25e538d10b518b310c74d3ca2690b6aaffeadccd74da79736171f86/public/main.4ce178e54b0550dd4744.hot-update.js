...
___CSS_LOADER_EXPORT___.push([module.id, `:root {
    ...
    --skl-ds-elevation-1: box-shadow: 0px 4px 20px rgba(0, 0, 0, 0.25);
}`, "",{"version":3,"sources":["webpack://./src/styles/variables.css"],"names":[],"mappings":"AAAA;IACI,+BAA+B;IAC/B,4BAA4B;;IAE5B,wBAAwB;IACxB,wBAAwB;;IAExB,kEAAkE;AACtE","sourcesContent":[":root {\n    --T-surface-0-on-color: #1a1a1a;\n    --T-surface-0-color: #E6E6E6;\n\n    --T-alert-on-color: #fff;\n    --T-alert-color: #CC1E1E;\n\n    --skl-ds-elevation-1: box-shadow: 0px 4px 20px rgba(0, 0, 0, 0.25);\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=main.4ce178e54b0550dd4744.hot-update.js.map