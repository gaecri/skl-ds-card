...
.skl-ds-widget--vertical .skl-ds-text {
  margin-top: 4px;
}`, "",{"version":3,"sources":["webpack://./src/stories/components/molecules/skl-ds-widget/skl-ds-widget.scss"],"names":[],"mappings":"AAAA;EACE,aAAA;EACA,mBAAA;AACF;;AAEA;EACE,aAAA;EACA,mBAAA;AACF;AAAE;EACE,gBAAA;AAEJ;;AAEA;EACE,kBAAA;AACF;AACE;EACE,eAAA;AACJ","sourcesContent":[".skl-ds-widget {\n  display: flex;\n  align-items: center;\n}\n\n.skl-ds-widget--horizontal {\n  display: flex;\n  align-items: center;\n  .skl-ds-text {\n    margin-left: 4px;\n  }\n}\n\n.skl-ds-widget--vertical {\n  text-align: center;\n\n  .skl-ds-text {\n    margin-top: 4px;\n  }\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=src_stories_components_molecules_skl-ds-widget_skl-ds-widget_jsx.f76399479ea5796df0af.hot-update.js.map