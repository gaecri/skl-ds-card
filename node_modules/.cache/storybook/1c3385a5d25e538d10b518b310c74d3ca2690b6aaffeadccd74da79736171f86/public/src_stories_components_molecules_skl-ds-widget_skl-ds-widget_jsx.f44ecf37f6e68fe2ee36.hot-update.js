...
}`, "",{"version":3,"sources":["webpack://./src/stories/components/atoms/skl-ds-text/skl-ds-text.scss"],"names":[],"mappings":"AAAA;EACE,kCAAA;AACF;;AAEA;EACE,8BAAA;AACF;;AAEA;EACE,4BAAA;AACF;;AAEA;EACE,6BAAA;AACF;;AAEA;EACE,6BAAA;AACF","sourcesContent":[".skl-ds-text--black {\n  color: var(--T-surface-0-on-color);\n}\n\n.skl-ds-text--white {\n  color: var(--T-alert-on-color);\n}\n\n.skl-ds-text--small {\n  font-size: var(--text-small)\n}\n\n.skl-ds-text--medium {\n  font-size: var(--text-medium)\n}\n\n.skl-ds-text--bold {\n  font-weight: var(--text-bold)\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=src_stories_components_molecules_skl-ds-widget_skl-ds-widget_jsx.f44ecf37f6e68fe2ee36.hot-update.js.map