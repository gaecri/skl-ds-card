...
___CSS_LOADER_EXPORT___.push([module.id, `:root {
    ...
    --text--medium:
    --text--small:
}`, "",{"version":3,"sources":["webpack://./src/styles/variables.css"],"names":[],"mappings":"AAAA;IACI,+BAA+B;IAC/B,4BAA4B;;IAE5B,wBAAwB;IACxB,wBAAwB;;IAExB,sDAAsD;IACtD;;;AAGJ","sourcesContent":[":root {\n    --T-surface-0-on-color: #1a1a1a;\n    --T-surface-0-color: #E6E6E6;\n\n    --T-alert-on-color: #fff;\n    --T-alert-color: #CC1E1E;\n\n    --skl-ds-elevation-1: 0px 4px 20px rgba(0, 0, 0, 0.25);\n    --text--small:\n    --text--medium:\n    --text--small:\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=main.19e88e3f83867997da66.hot-update.js.map