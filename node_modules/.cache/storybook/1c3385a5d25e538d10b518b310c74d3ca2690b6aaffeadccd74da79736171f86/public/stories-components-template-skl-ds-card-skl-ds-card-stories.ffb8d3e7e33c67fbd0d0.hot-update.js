...
.skl-ds-card--alert .skl-ds-card-header {
  background-color: red;
}`, "",{"version":3,"sources":["webpack://./src/stories/components/template/skl-ds-card/skl-ds-card.scss"],"names":[],"mappings":"AAAA;EACE,sBAAA;EACA,mBAAA;AACF;;AAEA;EACE,qBAAA;AACF;;AAGE;EACE,qBAAA;AAAJ","sourcesContent":[".skl-ds-card {\n  background-color: #fff;\n  border-radius: 16px;\n}\n\n.skl-ds-card-header__background--alert {\n  background-color: red;\n}\n\n.skl-ds-card--alert {\n  .skl-ds-card-header {\n    background-color: red;\n  }\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=stories-components-template-skl-ds-card-skl-ds-card-stories.ffb8d3e7e33c67fbd0d0.hot-update.js.map