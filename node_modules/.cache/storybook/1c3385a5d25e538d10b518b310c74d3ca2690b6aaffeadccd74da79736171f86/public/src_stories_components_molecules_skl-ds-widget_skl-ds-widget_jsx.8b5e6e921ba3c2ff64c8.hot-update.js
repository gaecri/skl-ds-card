...
.skl-ds-text--bold {
  font-weight: 600;
}`, "",{"version":3,"sources":["webpack://./src/stories/components/atoms/skl-ds-text/skl-ds-text.scss"],"names":[],"mappings":"AAAA;EACE,kCAAA;EACA,kCAAA;AACF;;AAEA;EACE,WAAA;AACF;;AAEA;EACE,eAAA;AACF;;AAEA;EACE,eAAA;AACF;;AAEA;EACE,gBAAA;AACF","sourcesContent":[".skl-ds-text--black {\n  color: var(--T-surface-0-on-color);\n  font-family: 'Poppins', sans-serif;\n}\n\n.skl-ds-text--white {\n  color: #fff;\n}\n\n.skl-ds-text--small {\n  font-size: 12px;\n}\n\n.skl-ds-text--medium {\n  font-size: 14px;\n}\n\n.skl-ds-text--bold {\n  font-weight: 600;\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=src_stories_components_molecules_skl-ds-widget_skl-ds-widget_jsx.8b5e6e921ba3c2ff64c8.hot-update.js.map